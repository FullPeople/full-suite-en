...
const MODAL_ID = "com.full-suite-en/dm-announcement";
...
const ISSUE_TYPE_LABELS: Record<string, { label: string; cls: string }> = {
  ...
  feature: { label: "REQ",     cls: "t-feature" },
  feat:    { label: "REQ",     cls: "t-feature" },
  wip:     { label: "WIP",     cls: "t-wip" },
  done:    { label: "DONE",    cls: "t-done" },
  fixed:   { label: "DONE",    cls: "t-done" },
};
const ISSUE_LEVEL_LABELS: Record<string, { label: string; cls: string }> = {
  critical: { label: "Crit", cls: "l-critical" },
  high:     { label: "High", cls: "l-high" },
  medium:   { label: "Med",  cls: "l-medium" },
  med:      { label: "Med",  cls: "l-medium" },
  low:      { label: "Low",  cls: "l-low" },
};
