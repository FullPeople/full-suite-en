...
// popover overlay.
const CLUSTER_POPOVER_ID = "com.full-suite-en/cluster";          // trigger
const CLUSTER_ROW_POPOVER_ID = "com.full-suite-en/cluster-row";  // row
const CLUSTER_URL = assetUrl("cluster.html");
const CLUSTER_ROW_URL = assetUrl("cluster-row.html");
const BC_CLUSTER_ROW_TOGGLE = "com.full-suite-en/cluster-row-toggle";
const BC_CLUSTER_ROW_STATE = "com.full-suite-en/cluster-row-state";
...
OBR.onReady(() => {
  ...
  OBR.broadcast.onMessage("com.full-suite-en/cluster-row-width", async (event) => {
