...
const SETTINGS_POPOVER_ID = "com.full-suite-en/settings";
const SETTINGS_URL = assetUrl("settings.html");

// Broadcast IDs
const BC_TIMESTOP_TOGGLE = "com.full-suite-en/timestop-toggle";
const BC_FOCUS_TRIGGER = "com.full-suite-en/focus-trigger";
...
const BC_TOGGLE_CC_PANEL = "com.full-suite-en/cc-panel-toggle";
...
const LS_ANNOUNCE_SEEN = "full-suite-en/announce-seen-version";
...
const BC_CLUSTER_ROW_WIDTH = "com.full-suite-en/cluster-row-width";
...
OBR.onReady(async () => {
  installDebugOverlay();
  OBR.broadcast.onMessage("com.full-suite-en/timestop-state", (event) => {
