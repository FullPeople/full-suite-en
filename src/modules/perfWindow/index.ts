...
//
// Local state: `full-suite-en/perf-window/visible` localStorage key.
...
const POPOVER_ID = "com.full-suite-en/perf-window";
...
export const LS_PERF_VISIBLE = "full-suite-en/perf-window/visible";
...
async function openPerf(): Promise<void> {
  try {
    ...
    // popover stays at the previous coordinates.
    if (isOpen) {
