...
// Suite state lives in scene metadata under "com.full-suite-en/state". When the
...
const SUITE_STATE_KEY = "com.full-suite-en/state";
      ...
      if (e.shiftKey && (e.key === "A" || e.key === "a")) {
        ...
        try {
          OBR.broadcast.sendMessage(
            "com.full-suite-en/bestiary-shortcut-toggle",
            {},
            { destination: "LOCAL" }
          );
        } catch {}
        ...
        <div class="header-row">
          ...
          <div class="source-filter-wrap">
            <input
              ...
              title={lang === "zh"
                ? "按来源代码筛选（如 PHB / 你的本子英文名）"
                : "Filter by source code (e.g. PHB / your homebrew tag)"}
            />
            {sourceFilter && (
              <button
