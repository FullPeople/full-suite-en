...
const POPOVER_ID = "com.full-suite-en/bestiary-group-saves";
...
const BC_FIRE = "com.full-suite-en/bestiary-group-save-fire";
const BC_FIRE_INIT = "com.full-suite-en/bestiary-group-init-fire";
...
const BC_FIRE_HP = "com.full-suite-en/bestiary-group-hp-fire";
const BC_STATE = "com.full-suite-en/bestiary-group-save-state";
...
export async function setupGroupSaves(): Promise<void> {
  ...
  unsubs.push(
    OBR.broadcast.onMessage("com.full-suite-en/bestiary-group-save-state-request", async () => {
