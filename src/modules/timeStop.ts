...
const BC_TOGGLE = "com.full-suite-en/timestop-toggle";
const BC_STATE = "com.full-suite-en/timestop-state";
 ...
 *  force-on time stop without going through the user toggle. Only
 *  the GM client should call this — players don't have scene-write
