...
const POPOVER_ITEM_ID = "com.full-suite-en/metadata-inspector/item";
const POPOVER_META_ID = "com.full-suite-en/metadata-inspector/meta";
...
const BC_INSPECTOR_SET_MODE = "com.full-suite-en/metadata-inspector/set-mode";
...
const KNOWN_NAMESPACES: PluginInfo[] = [
  { prefix: "com.full-suite-en/", zh: "枭熊套件 — 套件状态 / 面板布局", en: "OBR Suite — state / panel layout", badgeClass: "suite" },
  { prefix: "com.full-suite-en/portals/", zh: "枭熊套件 · 传送门", en: "OBR Suite · Portals", badgeClass: "suite" },
  { prefix: "com.full-suite-en/dice", zh: "枭熊套件 · 骰子", en: "OBR Suite · Dice", badgeClass: "suite" },
  { prefix: "com.full-suite-en/portals", zh: "枭熊套件 · 传送门数据", en: "OBR Suite · Portals data", badgeClass: "suite" },
