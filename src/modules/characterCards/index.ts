...
const PANEL_MODAL_ID = "com.full-suite-en/cc-panel";
const INFO_POPOVER_ID = "com.full-suite-en/cc-info";
const BIND_MODAL_ID = "com.full-suite-en/cc-bind-picker";
...
export async function setupCharacterCards(): Promise<void> {
  ...
  unsubs.push(
    OBR.broadcast.onMessage("com.full-suite-en/cc-panel-toggle", async () => {
  ...
  unsubs.push(
    OBR.broadcast.onMessage("com.full-suite-en/cc-panel-closed", () => {
      panelOpen = false;
    })
  );
  ...
  unsubs.push(
    OBR.broadcast.onMessage("com.full-suite-en/cc-shortcut-toggle", () => {
      toggleMainPanel();
    })
  );
