...
// Old single-key "full-suite-en/sfx-on" still acts as a master fallback
...
const LS_KEY_DICE = "full-suite-en/sfx-dice";          // dice rolling pipeline
const LS_KEY_INITIATIVE = "full-suite-en/sfx-initiative"; // turn chime, etc.
const LS_KEY_LEGACY = "full-suite-en/sfx-on";
