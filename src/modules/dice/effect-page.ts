...
const BC_DICE_FORCE_CLEAR = "com.full-suite-en/dice-force-clear";
const BC_DICE_CLEAR_ALL   = "com.full-suite-en/dice-clear-all";
const BC_DICE_FADE_START  = "com.full-suite-en/dice-fade-start";
...
const BC_DICE_HISTORY_REVEAL = "com.full-suite-en/dice-history-reveal";
...
const MODAL_ID = `com.full-suite-en/dice-effect-${rollId}`;
...
// modal (anchored at HISTORY_RIGHT_OFFSET=5 / HISTORY_BOTTOM_OFFSET=12
// in index.ts and sized 320×360). We aim ~50px in from each edge so
// the dice visually plunge INTO the modal's lower-right area (where
// the freshest row will land). The dedicated d20 trigger button this
// used to target was removed — there's no longer a dedicated landing
// button, so we point at the modal itself.
