...
// "full-suite-en/dice/history" so the same data drives both views.

const BROADCAST_DICE_ROLL = "com.full-suite-en/dice-roll";
const BC_DICE_HISTORY_FILTER = "com.full-suite-en/dice-history-filter";
const BC_DICE_PANEL_TOGGLE = "com.full-suite-en/dice-panel-toggle";
...
const POPOVER_ID_FOR_RESIZE = "com.full-suite-en/dice-history";
...
OBR.onReady(async () => {
  ...
  document.getElementById("btnDismiss")?.addEventListener("click", () => {
    try {
      OBR.broadcast.sendMessage(
        "com.full-suite-en/dice-history-dismiss",
        {},
        { destination: "LOCAL" },
      );
    } catch {}
