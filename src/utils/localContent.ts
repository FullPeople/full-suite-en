...
export const BC_LOCAL_CONTENT_CHANGED = "com.full-suite-en/local-content-changed";
//
// Storage layout:
...
const LS_INDEX = "full-suite-en/local-content/index";
const LS_FILE_PREFIX = "full-suite-en/local-content/file:";
