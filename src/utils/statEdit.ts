...
export const BUBBLES_META_KEY = "com.full-suite-en/bubbles/data";
  ...
  try {
    await OBR.scene.items.updateItems([itemId], (drafts) => {
      for (const d of drafts) {
        ...
        // Mirror to the upstream key only when it was already there
        // (existing scenes that imported the upstream extension's data).
