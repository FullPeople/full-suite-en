...
const STORAGE_PREFIX = "full-suite-en/panel-offset/";
...
const SIZE_PREFIX = "full-suite-en/panel-size/";
 ...
 *  with the new anchor. */
export const BC_PANEL_DRAG_END = "com.full-suite-en/panel-drag-end";
...
export const BC_PANEL_RESET = "com.full-suite-en/panel-reset";
...
export const BC_PANEL_DRAG_START = "com.full-suite-en/panel-drag-start";
...
export const BC_PANEL_DRAG_MOVE = "com.full-suite-en/panel-drag-move";

/** LOCAL broadcast: drag cancelled (pointercancel or escape). Modal
 *  closes itself, offset is NOT persisted. */
export const BC_PANEL_DRAG_CANCEL = "com.full-suite-en/panel-drag-cancel";
...
export const DRAG_PREVIEW_MODAL_ID = "com.full-suite-en/drag-preview";

/** Layout-editor modal id. Opened from Settings → 基础设置. */
export const LAYOUT_EDITOR_MODAL_ID = "com.full-suite-en/layout-editor";
...
export const BC_OPEN_LAYOUT_EDITOR = "com.full-suite-en/open-layout-editor";
...
export const BC_PANEL_SIDE_HINT = "com.full-suite-en/panel-side-hint";
