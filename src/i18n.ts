...
const TR: Dict = {
  ...
  charCardEnWarning: {
    zh: "",
    en: "JSON-only character card support. Use the fullscreen panel to import / export individual cards.",
  },
  ...
  ccBindUploadHint: {
    zh: "先去右下角",
    en: "Drop a .json card into the right rail of the",
  },
  ccBindUploadHint2: {
    zh: "面板的右侧栏拖一张 .json 角色卡上来",
    en: "panel.",
  },
  ...
  ccPanelDownloadTplTitle: {
    zh: "导出当前角色卡为 JSON（在角色卡全屏面板里）",
    en: "Export the current character card as JSON (from the fullscreen card panel)",
  },
  ccPanelClose: { zh: "关闭 (Esc)", en: "Close (Esc)" },
  ccPanelDragHint: { zh: "拖拽 .json 到此处导入，或", en: "Drag a .json card here to import, or" },
  ccPanelChooseFile: { zh: "📁 选择文件", en: "📁 Choose File" },
  ccPanelChooseFileTitle: {
    zh: "打开本地文件选择器导入 .json 角色卡",
    en: "Open local file picker to import a .json card",
  },
  ccPanelRefreshHint: {
    zh: "每张卡片旁的 ↻ 可重新选择 .json 覆盖更新",
    en: "Click ↻ next to a card to re-pick the .json file and overwrite",
  },
  ccPanelEmpty: { zh: "从右侧选择一张角色卡", en: "Select a character card from the right" },
  ccPanelEmpty2: { zh: "拖拽 .json 到右侧栏导入", en: "Drag .json onto the right rail to import" },
  ...
  ccPanelOnlyXlsx: { zh: "只支持 .json 文件", en: "Only .json files are supported" },
  ...
  // === Search bar ===
  searchPlaceholder: {
    zh: "搜索内容库…（怪物/法术/物品/职业/种族…）",
    en: "Search content library… (monsters/spells/items/classes/races…)",
  },
